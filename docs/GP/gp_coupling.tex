...
%              Not yet drafted; they are a separate submission item, not part of
%              this file.
%
...
%
% NONE of the above was read off the guide directly -- ScienceDirect returns HTTP
% 403 to automated fetches, so these come from search summaries. Confirm all three
% against the live guide before submitting:
